...
latex_documents = [
    (master_doc, 'statinf.tex', u'statinf Documentation',
     u'Florian Felice', 'manual'),
]
...
man_pages = [
    (master_doc, 'statinf', u'statinf Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'statinf', u'statinf Documentation',
     author, 'statinf', 'One line description of project.',
     'Miscellaneous'),
]
