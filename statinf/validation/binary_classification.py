...
if sys.platform in ['darwin']:
    output_path = f'/Users/{getpass.getuser()}/Downloads/binary_models_OR_comparison.txt'
elif sys.platform in ['linux']:
    output_path = f'/home/{getpass.getuser()}/binary_models_OR_comparison.txt'
elif sys.platform in ['win32', 'win64']:
    output_path = f'C:/Users/{getpass.getuser()}/Downloads/binary_models_OR_comparison.txt'
else:
...
pc.write('i,quad_vars,data_balance,SM_accuracy,Perceptron_accuracy,MLP_accuracy,MLP2_accuracy,DMLP_accuracy,DMLP2_accuracy,Real_OR,SM_OR,Perceptron_OR,MLP_OR,MLP2_OR,DMLP_OR,DMLP2_OR', output_path, perm='w')
...
for i in pc.verbose_display(range(args.iterations)):
    try:
        ...
        while (data_balance < 0.02) or (data_balance > 0.98):
            coeffs_bin = np.random.uniform(low=-10, high=10, size = 15)
        ...
        nn = MLP(loss='bce', optimizer='adam')
        ...
        nn2.add(Layer(10, 1, activation='sigmoid'))
        ...
        pc.write(f'{i},{quad_add},{data_balance},{logit_acc},{bin_pt_acc},{bin_mlp_acc},{bin_mlp2_acc},{bin_dmlp_acc},{bin_dmlp2_acc},{real_OR},{sm_or},{pt_or},{mlp_or},{mlp2_or},{dmlp_or},{dmlp2_or}', output_path)
    except:
